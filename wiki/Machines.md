...
- **TRX50-SAGE** — three disks: `nvme2` boot (512M ESP + ext4 `/`); `nvme0` + `nvme1` each an mdraid member → **RAID 0 xfs `vm-data`** at `/vm-data` (`noatime,nodiratime`) for high-throughput VM storage.
