  ...
  wayland.windowManager.hyprland = {
    settings = {
      monitor = [
        ...
        "desc:Philips Consumer Electronics Company LT6911UXE 0x00000001, 3840x2160@60, auto, 1, mirror, desc:Microstep MPG322UX OLED 0x01010101" # Mirror if any other output detected
